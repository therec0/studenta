...
// @version      1.6
// @description  Minimalistic stoic UI with visible buttons, subtle highlights, popup for >10% absences.
// @author       YOU
// @match        *://*/studentgo/*
// @grant        none
// ==/UserScript==
...
(function () {
  ...
  function setupAnalyzer(tbody) {
    ...
    panel.innerHTML = `
      <div style="
        ...
        font-family:Helvetica, Arial, sans-serif;width:340px;z-index:999999;
        max-height:80vh;overflow:auto;color:${textColor};">
  ...
  Made by <a href="https://snapchat.com/t/68hTayny" target="_blank" style="color:#888;text-decoration:none;">Kebab Mies </a>
</div>
